...
(function() {
  ...
  var products = [
    { id: 'PS-ANTIBRILLO',   name: 'Protector Solar Anti-Brillo',             price: 384, category: 'Protección Solar', skin: ['grasa','mixta'],                   concerns: ['brillo','poros','acne'],              climate: ['calido','templado'],       makeup: true,  desc: 'SPF 50+ mate. Control de brillo todo el día.' },
    { id: 'PS-ANTIMANCHAS',  name: 'Protector Solar Anti-Manchas',            price: 384, category: 'Protección Solar', skin: ['todo tipo'],                       concerns: ['manchas','pigmentacion'],             climate: ['calido','templado','frio'], makeup: true,  desc: 'SPF 50+ con Vitamina C estable. Previene manchas.' },
    { id: 'PS-HIALURONICO',  name: 'Protector Solar con Ácido Hialurónico',   price: 384, category: 'Protección Solar', skin: ['seca','sensible','mixta'],          concerns: ['deshidratacion','lineas finas'],      climate: ['frio','templado'],         makeup: true,  desc: 'SPF 50+ hidratante. Piel seca y sensible.' },
    { id: 'PS-NIACINAMIDA',  name: 'Protector Solar con Niacinamida',         price: 384, category: 'Protección Solar', skin: ['todo tipo'],                       concerns: ['poros','brillo','manchas'],           climate: ['calido','templado'],       makeup: true,  desc: 'SPF 50+ multifunción. Niacinamida 5%.' },
    { id: 'PS-TOQUESECO',    name: 'Protector Solar Toque Seco',              price: 384, category: 'Protección Solar', skin: ['grasa','mixta'],                   concerns: ['brillo'],                            climate: ['calido'],                  makeup: true,  desc: 'SPF 50+ ultra seco. Prep perfecta bajo maquillaje.' },
    { id: 'PS-BARRA',        name: 'Protector Solar en Barra',                price: 360, category: 'Protección Solar', skin: ['todo tipo'],                       concerns: ['reaplica'],                          climate: ['calido','templado'],       makeup: false, desc: 'SPF 50+ compacto. 100% mineral, para llevar.' },
